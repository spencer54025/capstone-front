...
export default class BookDetail extends Component {
	...
	deleteBook(book) {
		...
		axios
			.delete(`https://svp-capstone-back.herokuapp.com/book/delete/${book.id}`)
	...
	getBook() {
		axios
			.get(
				`https://svp-capstone-back.herokuapp.com/book/get/${this.props.match.params.slug}`
			)
			.then((res) => {
				this.setState({
					book: res.data,
	...
	render() {
		const { id, title, summary, author, price, img, genre } = this.state.book;
			...
			<div className="single-book-wrapper">
				{this.state.editMode === false ? (
					<div className="book-detail-wrapper">
						...
						<button
							onClick={() => {
								this.openAlert(), this.addToCart(this.state.book);
							}}
						>
							add to cart
						</button>
